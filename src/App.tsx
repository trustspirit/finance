...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: '/admin/requests', element: <ProtectedRoute requiredRoles={['admin', 'director', 'finance', 'approver_ops', 'approver_prep']}><AdminRequestsPage /></ProtectedRoute> },
      { path: '/admin/dashboard', element: <ProtectedRoute requiredRoles={['admin', 'director', 'finance']}><DashboardPage /></ProtectedRoute> },
      ...
      { path: '/admin/settlement/new', element: <ProtectedRoute requiredRoles={['admin', 'director', 'finance', 'approver_ops', 'approver_prep']}><SettlementPage /></ProtectedRoute> },
      { path: '/admin/settlements', element: <ProtectedRoute requiredRoles={['admin', 'director', 'finance', 'approver_ops', 'approver_prep']}><SettlementListPage /></ProtectedRoute> },
      { path: '/admin/settlement/:id', element: <ProtectedRoute requiredRoles={['admin', 'director', 'finance', 'approver_ops', 'approver_prep']}><SettlementReportPage /></ProtectedRoute> },
