...
exports.scanReceiptV2 = exports.weeklyApproverDigest = exports.onRequestStatusChange = exports.onRequestCreated = exports.deleteUserAccount = exports.cleanupDeletedProjects = exports.downloadFileV2 = exports.uploadBankBookV2 = exports.uploadReceiptsV2 = void 0;
...
function suggestBudgetCode(text) {
...
// 영수증 OCR 스캔
exports.scanReceiptV2 = (0, https_1.onCall)({ memory: '512MiB', timeoutSeconds: 120 }, async (request) => {
    if (!request.auth) {
        throw new https_1.HttpsError('unauthenticated', 'Must be logged in');
    }
    ...
    if (files.length > 10) {
        throw new https_1.HttpsError('invalid-argument', 'Maximum 10 files allowed');
    }
    ...
    if (errors.length === files.length) {
        throw new https_1.HttpsError('internal', errors.join('\n'));
    }
